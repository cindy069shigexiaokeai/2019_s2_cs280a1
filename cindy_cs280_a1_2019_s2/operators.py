...
class OperatorStore(object):
    ...
    def add(self, operator):
        ...
        #To hold a rescue drone endorsement, the operator must have been involved in five prior rescue operations.
        if operator.operations < 5:
            action.add_message("More than 5 rescue operations is required")
        else:
